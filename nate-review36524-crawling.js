...
(async () => {
    ...
    for (const sc of scList) {
        ...
        for (const link of links) {
          ...
          - newTitle(제목): 메인 키워드가 반드시 문장의 '앞부분'에 오도록 배치할 것. (예: "양말 세균(키워드) 방치하면 큰일나는 이유" O / "큰일나는 이유는 양말 세균(키워드) 때문" X)
          ...
          1. newTitle: 
             - 20~30자 이내. 
             - **중요: 따옴표, 괄호, 느낌표, 물음표, 말줄임표 등 모든 특수문자 절대 사용 금지.**
             - 오직 한글, 숫자, 띄어쓰기만 사용하여 깔끔한 문장으로 완성할 것.
             - 호기심을 자극하되 '낚시성'이 아닌 정보 요약형 문장.
